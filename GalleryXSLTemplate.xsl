...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:openAsset="http://openasset.axomic.com/OpenAsset/XML" version="1.0">
	...
	<xsl:template match="channel"> 
		...
		<style>
			div#smCarousel{width:252px;} 
			div#smCarousel .carousel-inner {text-align:center;} 
			div#smCarousel .carousel-inner > .item > img {border-width:0; height:158px; width:auto !important; margin:0 auto;}
			div#smCarousel .carousel-control {left:0px;} 
			div#smCarousel .carousel-control.right {right:0px;left:auto;} 
			div#smCarousel .carousel-caption {padding:5px 15px; text-align:left;}
			div#smCarousel .carousel-caption a {color:white !important;} 
			div#smCarousel .carousel-caption a:hover {color:#ef3125 !important;} 
		</style> 
